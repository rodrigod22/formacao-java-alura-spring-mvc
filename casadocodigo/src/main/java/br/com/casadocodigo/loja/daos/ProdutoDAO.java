...
public class ProdutoDAO {
	...
	@Test
	public BigDecimal somaPecoPorTipoPreco(TipoPreco tipoPreco) {
		TypedQuery<BigDecimal> query = manager.createQuery("select sum(preco.valor) from Produto p join p.precos"
				+ " preco where preco.tipo = :tipoPreco", BigDecimal.class);
